 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation AddProductToCart($input: AddProductToCartInput!) {\n  addProductToCart(input: $input) {\n    __typename\n    id\n    lines {\n      __typename\n      id\n      product {\n        __typename\n        id\n        title\n        stock\n        price\n      }\n      qty\n    }\n    lineCount\n    total\n  }\n}"): (typeof documents)["mutation AddProductToCart($input: AddProductToCartInput!) {\n  addProductToCart(input: $input) {\n    __typename\n    id\n    lines {\n      __typename\n      id\n      product {\n        __typename\n        id\n        title\n        stock\n        price\n      }\n      qty\n    }\n    lineCount\n    total\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
