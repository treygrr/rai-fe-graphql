...
import { AddProductToCartDocument, CartsDocument, type Product } from '../gql/codegen/graphql';
const qty = ref<number>()

const props = defineProps<{ product: Product, enableAddToCart?: boolean, cartId?: string }>()
